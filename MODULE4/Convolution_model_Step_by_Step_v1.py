...
#creating a subplot with two side-by-side images
fig, axarr = plt.subplots(1, 2)
axarr[0].set_title('x')          # Set titles for the subplots
axarr[0].imshow(x[0, :, :, 0])   #Display the index 0 of the original `x` array
axarr[1].set_title('x_pad')         # Set titles for the subplots
